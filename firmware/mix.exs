defmodule CalendarFirmware.MixProject do
  use Mix.Project

  @app :calendar_firmware
  @version "0.1.0"
  ...
  def application do
    [
      mod: {CalendarFirmware.Application, []},
  ...
  defp deps do
    [
      ...
      {:calendar_app, path: "../calendar_app"},

      # Dependencies for specific targets
      {:nerves_system_br, "~> 1.17", runtime: false, targets: @all_targets},
